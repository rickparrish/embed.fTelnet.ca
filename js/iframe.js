...
function Connect() {
    HtmlTerm.ConnectionType = TargetConnectionType;
    HtmlTerm.Hostname = TargetHostname;
    HtmlTerm.Port = TargetPort;
    HtmlTerm.ProxyHostname = (TargetProxy ? "proxy.ftelnet.ca" : "");
    HtmlTerm.ServerName = TargetHostname;
    switch (TargetEmulation) {
        case 'c64':
            if (!Crt.C64) {
                Crt.C64 = true;
